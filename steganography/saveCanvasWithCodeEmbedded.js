...
embedCode=(canvas, ctx)=>{
	...
	*/
	let html = document.documentElement.outerHTML + '<<' + 'STOP>>';  // this stop identifier is optional, but it is used by the other page in this repository that extracts text from an image
